...
export default function TwitterTweetPreview(props) {
    ...
    return (
        <div className={classes.cardRoot} id="twitter-tweet-node">
            <div className={classes.cardProfileRoot}>
            ...
            <div className={classes.cardContentRoot}>
                <div>
                    <span className={classes.name}>
                        {name} {
                        verified &&
                        <svg className={classes.verifiedIcon} viewBox="0 0 24 24" aria-label="Verified account">
                            <g>
                                <path
                    ...
                    <span className={classes.userName}> @{userName} · {age}</span>
                </div>
                <div>
                    {description}
                </div>
                <div className={classes.cardFooterRoot}>
                    <div className={classes.cardFooterItem}>
                        <svg className={classes.footerIcon} viewBox="0 0 24 24">
                            <g>
                                <path
